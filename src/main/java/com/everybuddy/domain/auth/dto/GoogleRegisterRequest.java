...
public class GoogleRegisterRequest {
    ...
    public static GoogleRegisterRequest of(String tempToken, String country, String birthday,
                                           String gender, String bio, List<String> tags,
                                           List<UserLanguageRequest> languages) {
