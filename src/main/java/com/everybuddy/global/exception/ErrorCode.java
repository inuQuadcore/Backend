...
public enum ErrorCode {
    ...
    INVALID_VIDEO_FORMAT(HttpStatus.BAD_REQUEST, 400, "지원하지 않는 영상 형식입니다. (mp4, mov)"),
    VIDEO_FILE_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE, 413, "영상 파일 크기가 제한을 초과했습니다. (최대 50MB)"),
    VIDEO_CONVERT_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, 500, "영상에서 오디오 추출 중 오류가 발생했습니다."),
